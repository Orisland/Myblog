...
<c:if test="${pageCount>0}">
    ...
    <c:if test="${pageNo>1}">
        <a href="page?pageNo=1&flagman=11">第一页</a>
        <a href="page?pageNo=${pageNo-1}&flagman=11">上一页</a>
    </c:if>
    <c:if test="${pageNo!=pageCount}">
        <a href="page?pageNo=${pageNo+1}&flagman=11">下一页</a>
        <a href="page?pageNo=${pageCount}&flagman=11">最后一页</a>
    </c:if>
    <div id="table">
        <table>
